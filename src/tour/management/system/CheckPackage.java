...
public class CheckPackage extends JFrame{
    ...
    CheckPackage() {    
      ...
      String[] package1 = new String[]{"package1.jpeg","BASIC PACKAGE","6 days and 7 Nights", "Receive at drop point", "Half Day town Tour", "Welcome drinks on Arrival", "Daily Buffet", "Free any 3 night Bonfire", "English Speaking Guide", "BOOK NOW", "All weather Special", "Rs 12000 only"};
      String[] package2 = new String[]{"package2.jpeg","GOOD PACKAGE","4 days and 3 Nights", "Any entrance Free Tickets", "2 Day town and near tour", "Welcome drinks on Arrival", "Night Hike", "Free any 3 night Bonfire", "1 free DJ night", "BOOK NOW", "Winter Special", "Rs 25000 only"};
      String[] package3 = new String[]{"package3.jpeg","PREMIUIM PACKAGE","6 days and 5 Nights", "Free Pick and Drop", "Free Skiing, Ski lifts & many other", "Welcome drinks on Arrival", "Daily Buffet", "Stay in 5 Star Hotel(Camping also)", "BBQ Dinner", "BOOK NOW", "Winter Special", "Rs 45000 only"};
